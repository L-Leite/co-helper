...
#ifdef DLL_EXPORT
#define POLYHOOK_EXPORT __declspec(dllexport)
#else
#define POLYHOOK_EXPORT __declspec(dllimport)
#endif
...
namespace PLH {
	...
	public:
		...
		POLYHOOK_EXPORT RuntimeError();
		RuntimeError(Severity Sev, const std::string& Msg);
		virtual ~RuntimeError() = default;
		POLYHOOK_EXPORT const Severity GetSeverity() const;
		POLYHOOK_EXPORT const std::string GetString() const;
	private:
		Severity m_Severity;
	...
	{
	public:
		POLYHOOK_EXPORT AbstractDetour( bool bRegister = true );
		...
		POLYHOOK_EXPORT void SetupHook(BYTE* Src, BYTE* Dest);
...
#define Detour X86Detour
	...
	public:
		...
		POLYHOOK_EXPORT X86Detour( bool bRegister = true );
...
#define Detour X64Detour
	...
	public:
		...
		POLYHOOK_EXPORT void SetupHook(BYTE** Vtable, const int Index, BYTE* Dest);
		template<typename T>
		T GetOriginal()
		{
...
#define _PTR_MAX_VALUE ((PVOID)0xFFF00000)
	...
	public:
		...
		virtual void UnHook() override;
		POLYHOOK_EXPORT void SetupHook(BYTE* pClass, const int Index, BYTE* Dest);
		template<typename T>
		T GetOriginal()
		{
...
#define ResolveRVA(base,rva) (( (BYTE*)base) +rva)
	...
	public:
		...
		POLYHOOK_EXPORT void SetupHook(const char* LibraryName,const char* SrcFunc, BYTE* Dest,const char* Module = "");
	private:
	...
	public:
		...
		POLYHOOK_EXPORT void SetupHook(BYTE* Src, BYTE* Dest,VEHMethod Method);
	...
	POLYHOOK_EXPORT void DestroyAll();
}//end PLH namespace
